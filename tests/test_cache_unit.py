"""
Comprehensive unit tests for cache.py module.

Tests cache storage, retrieval, expiration, error handling, and security
(path traversal protection, cache directory validation) with various data
