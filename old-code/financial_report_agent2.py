...
pip install markdown reportlab python-docx
        ...
        for attempt in range(self.config.max_retries):
            try:
                ...
                parsed = ParsedRequest(
                    ...
                    output_format=OutputFormat(parsed_json.get("output_format", "markdown")),
...
class PDFConverter:
    ...
    @staticmethod
    def markdown_to_pdf(markdown_content: str, output_path: str) -> None:
        """
        ...
        try:
            ...
            # libraries like xhtml2pdf or weasyprint for better HTML->PDF rendering
            ...
            for line in lines:
                ...
                # Regular text
                    ...
                    # Skip markdown table markers and code blocks
    ...
    def run(self, user_request: str, output_dir: str = "./out") -> ReportMetadata:
        ...
        if parsed.output_format == OutputFormat.PDF:
            ...
            try:
                ...
                converter.markdown_to_pdf(final_markdown, str(pdf_path))
